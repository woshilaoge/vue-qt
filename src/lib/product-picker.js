...
(function(factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function() {
            var p = this.getPosition(),
                ...
                '<span class="title"></span><div class="arrow fa fa-caret-down"></div>' + '</span>',
                ...
                '<button type="button" class="btn btn-warning" id="js-productpicker-reset">清空</button>' +
                '<button type="button" class="btn btn-primary" id="js-productpicker-ok">确定</button>' +
                '</div>' +

                '<a class="active" data-count="province">一级</a>' +
                (this.includeDem('city') ? '<a data-count="city">二级</a>' : '') +
        ...
        output: function(type) {
            ...
            districts = $.isNumeric(code) ? options["ChineseDistricts"][code] : null;
    ...
    CityPicker.other = $.fn.productpicker;

    // Register as jQuery plugin
    $.fn.productpicker = function(option) {
    ...
    $.fn.productpicker.Constructor = CityPicker;
    $.fn.productpicker.setDefaults = CityPicker.setDefaults;

    // No conflict
    $.fn.productpicker.noConflict = function() {
        $.fn.productpicker = CityPicker.other;
        return this;
    };

    $(function() {
        $('[data-toggle="city-picker"]').productpicker();
    });
});

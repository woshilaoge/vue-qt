...
export default {
    ...
    data() {
        return {
            checked: (this.checkedValue === true)
//            checked: (this.value === this.checkedValue || (this.checkedValue == 'true'))
        }
    },
    computed: {
    ...
    watch: {
        checked(val, old) {
            ...
            if(val){
                this.$emit('checked', {id:this.value,name:this.name,checked:this.checked})
            }else{
                this.$emit('checked',  {id:this.value,name:this.name,checked:this.checked})
            }
        ...
        checkedValue(){
            this.checked  = (this.checkedValue === true)
        }
    },
    created() {
